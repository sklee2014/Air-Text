...
def main():
    ...
    parser.add_argument('--save-dir', type=str, default='./TextRecognitionModule/MNIST/output',
                        help='where to save the trained model')
    parser.add_argument('--data-path', type=str, default='./TextRecognitionModule/MNIST/data',
                        help='where to save MNIST data')
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if args.save_model:
            ...
            torch.save(model.state_dict(), args.save_dir + "/mnist_cnn"+str(epoch)+".pt")
